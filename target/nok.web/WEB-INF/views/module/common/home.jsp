...
<link href="<c:url value="/resources/js/ui/kakao/page.css" />" rel="stylesheet">
<link href="<c:url value="/resources/js/ui/kakao/AXJ.min.css" />" rel="stylesheet">

<script src="<c:url value="/resources/js/jquery/jquery.min.js" />"></script>
<script src="<c:url value="/resources/js/dist/AXJ.min.js" />"></script>
    ...
    pageStart: function(){
        ...
        */
        ...
        myEditor.setConfig({
			...
			lang: "kr",
			height:300,
			frameSrc: "<c:url value="/resources/js/lib/AXEditor.html" />",
	...
	upload: {
		init: function(){
			...
			myUpload.setConfig({
                ...
                flash_url : "<c:url value="/resources/js/lib/swfupload.swf" />",
                flash9_url : "<c:url value="/resources/js/lib/swfupload_fp9.swf" />",
